...
type declAPIStorage interface {
	api.DeclarationAPIStorage
	storage.DeclarationAPIStorage
}

func testStoreDeclaration(t *testing.T, storage declAPIStorage, ctx context.Context, decl *ddm.Declaration) {
...
func testDeleteDeclaration(t *testing.T, storage declAPIStorage, ctx context.Context, id string) {
